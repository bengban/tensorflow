Pod::Spec.new do |s|
  s.name             = 'FindTensorFlowLiteSwift'
  s.version          = '2.5.0'
  ...
  s.module_name = 'FindTensorFlowLiteSwift'
  ...
  s.subspec 'Core' do |core|
    core.dependency 'FindTensorFlowLiteC', "#{s.version}"
  ...
  s.subspec 'CoreML' do |coreml|
    ...
    coreml.dependency 'FindTensorFlowLiteC/CoreML', "#{s.version}"
    coreml.dependency 'FindTensorFlowLiteSwift/Core', "#{s.version}"
  end

  s.subspec 'Metal' do |metal|
    metal.source_files = swift_dir + 'Sources/MetalDelegate.swift'
    metal.dependency 'FindTensorFlowLiteC/Metal', "#{s.version}"
    metal.dependency 'FindTensorFlowLiteSwift/Core', "#{s.version}"
